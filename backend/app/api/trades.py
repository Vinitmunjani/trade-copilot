...
async def list_trades(
    ...
    symbol: str | None = Query(None, description="Filter by symbol (e.g., EURUSD)"),
    ...
    score_min: int | None = Query(None, ge=1, le=10, description="Minimum AI score"),
    score_max: int | None = Query(None, ge=1, le=10, description="Maximum AI score"),
