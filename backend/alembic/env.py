...
from app.models import User, Trade, DailyStats, TradingRules, TradeLog, MetaAccount, Subscription, TrialAccountClaim, AdminAuditLog  # noqa: F401 — ensure models are registered
